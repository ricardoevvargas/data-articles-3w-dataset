...
> 👍 Sort description about each class label (after Table 4), and figure improvements.
...
| State label | Marking determined by an expert regarding the well condition in terms of operational status. See additional explanation in Subsection [Common Characteristics Among the Methods](#common-characteristics-among-the-methods) |
